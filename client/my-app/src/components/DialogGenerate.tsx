...
interface IDialogGenerate {
  openDialog: boolean,
  handleClose: () => void,
  handleSubmit: (courseMaterial: string, numberOfQuestions: number) => void,
}

export const DialogGenerate:React.FC<IDialogGenerate> = ({openDialog,handleClose,handleSubmit}) => {
  ...
  const validateSubmit = () => {
    ...
    handleSubmit(courseMaterial,numberOfQuestions);
    setCourseMaterial("");
    handleClose();
  }
